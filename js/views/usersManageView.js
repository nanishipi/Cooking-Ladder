                ...
                if (result.isConfirmed) {
                  Swal.fire(
                    ...
                    'success'
                      ...
                      if(result){
                        User.editUser(currentUser.name, currentUser.password, currentUser.email, currentUser.location, currentUser.gender, currentUser.birthday, currentUser.level, currentUser.experience, true, currentUser.quizzesCompleted)
                        location.reload();
                      }
                  })                 
                }
                ...
                if (result.isConfirmed) {
                  Swal.fire(
                    ...
                    'success'
                      ...
                      if(result){
                        User.editUser(currentUser.name, currentUser.password, currentUser.email, currentUser.location, currentUser.gender, currentUser.birthday, currentUser.level, currentUser.experience, false, currentUser.quizzesCompleted)
                        location.reload();
